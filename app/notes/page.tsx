            ...
            >
              ...
              <div className="bg-zinc-900 rounded-xl border border-white/10 overflow-hidden flex flex-col transition-all duration-300 active:scale-[0.98]">
                ...
                <div className={`h-20 w-full bg-gradient-to-br ${note.color} flex items-center justify-center relative overflow-hidden`}>
                    ...
                    <div className="absolute top-2 right-2 bg-black/30 backdrop-blur-md border border-white/10 px-1.5 py-0.5 rounded text-[10px] font-mono font-bold tracking-widest">
                        PDF
                    </div>
                </div>
                ...
                <div className="p-3">
                  ...
                  <div className="pt-2 border-t border-white/5 flex items-center justify-between text-[10px] text-zinc-500 mt-2">
                    <span className="flex items-center gap-1.5">
                        <FileText size={10} /> Read File
                    </span>
